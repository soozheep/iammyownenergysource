const SITE_URL = 'https://iammyownenergysource.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'I Am My Own Energy Source — Sonic Remedy | Soozhee',
        text: 'I don’t need their light to shine. I am my own energy source. — Soozhee',
        url: SITE_URL
      });
      return;
    } catch (e) {}
